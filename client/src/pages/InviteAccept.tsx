...
export default function InviteAccept() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!token) {
      setError("Ogiltig inbjudningslänk. Kontakta Solpulsen.");
      return;
    }
        ...
        <CardHeader className="text-center pb-2 pt-8">
          ...
          {done ? (
            <div className="flex flex-col items-center gap-3">
              ...
              <h1 className="text-xl font-bold text-white">Konto aktiverat</h1>
              <p className="text-sm text-muted-foreground">Ditt konto är nu aktivt. Du kan logga in.</p>
            </div>
          ) : (
            <>
              <div className="flex items-center justify-center gap-2 mb-2">
                <ShieldCheck className="w-5 h-5 text-amber-500" />
                <h1 className="text-xl font-bold text-white">Aktivera ditt konto</h1>
              </div>
              <p className="text-sm text-muted-foreground">Välj ett lösenord för att komma igång</p>
            </>
          )}
        </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 mt-4">
              ...
              {!token && (
                <p className="text-xs text-red-400 text-center">
                  Ogiltig inbjudningslänk. Kontakta Solpulsen CARE.
                </p>
              )}
            </form>
          )}
